...
public class DragonFight {
 ...
 String answer = JOptionPane.showInputDialog("yell or kick");		
		...
		if (answer.equals("kick")) {
			int damage = new Random ().nextInt(25);
		dragonHealth-=damage;
		}
		...
		if(dragonHealth<=0) {
			...
			else { JOptionPane.showMessageDialog(null, "good job the gold is now yours");			
	   //  15.  Else
		
			//-- Pop up a message that tells the their current health and the dragon's currently health (Bonus: Also display the amount of health that was lost for each player this round)
			JOptionPane.showMessageDialog(null, "you did"+"playerDamage"+"dragonDamage");
		}
